...
object ProcessLaterFunctionTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //有序流的水位线，简化设置
    stream.assignTimestampsAndWatermarks(WatermarkStrategy.forBoundedOutOfOrderness(Duration.ofSeconds(5)).withTimestampAssigner(new SerializableTimestampAssigner[Event] {
